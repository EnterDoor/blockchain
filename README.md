...
目前比较好的比特币交易所有这几家 [币安](https://www.binancezh.com/cn/register?ref=35258634)  [火币](https://www.huobi.vn/zh-cn/topic/invited/?invite_code=uqdp3)   [KuCoin](https://www.kcs.top/?rcode=Phex8b)，小白建议不要去小交易所,会有跑路的风险, 以上这几家它们都支持你所能听说过的绝大多数数字资产收发与存储，并且使用极为方便。
...
把交易所当作钱包用也不是不行，但，这里面的风险在于，绝大多数交易所做不到像当年的云币那样，从未出现过丢币的安全事故。交易所有真实丢币的，也有监守自盗的…… 所以，真不是随便哪一个交易所都可以当作钱包使用的。[币安](https://www.binancezh.com/cn/register?ref=35258634) 倒是可以无负担推荐，因为它的确靠谱。
...
> 1. 不要只做期货；
> 2. 选择靠谱的不作恶的交易所，比如 [币安](https://www.binancezh.com/cn/register?ref=35258634)……
...
本书内容保存在 [blockchain.enterdoor.org](http://blockchain.enterdoor.org/#/) 
本书完全开源，没有任何协议，你可以任意修改，任意发布
